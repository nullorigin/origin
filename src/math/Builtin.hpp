...
template <typename T> inline bool isNumber(T a) {
  return (__builtin_isnan(a) != 0 && __builtin_isinf(a) != 0 &&
          __builtin_isfinite(a) == 0);
}
...
inline int imul(int x, int y) { return x * y; }
inline int iadd(int x, int y) { return x + y; }
inline int isub(int x, int y) { return x - y; }
inline int idiv(int x, int y) { return x / y; }
...
inline long double logl(long double x) { return __builtin_logl(x); }

inline double log10(double x) { return __builtin_log10(x); }
inline float log10f(float x) { return __builtin_log10f(x); }
inline long double log10l(long double x) { return __builtin_log10l(x); }
...
inline double powi(double x, int y) { return __builtin_powi(x, y); }
...
inline long double sinl(long double x) { return __builtin_sinl(x); }

inline double sinh(double x) { return __builtin_sin(x); }
inline float sinhf(float x) { return __builtin_sinhf(x); }
inline long double sinhl(long double x) { return __builtin_sinhl(x); }
inline double sqrt(double x) { return __builtin_sqrt(x); }
inline float sqrtf(float x) { return __builtin_sqrtf(x); }
inline long double sqrtl(long double x) { return __builtin_sqrtl(x); }

inline double tan(double x) { return __builtin_tan(x); }
inline float tanf(float x) { return __builtin_tanf(x); }
inline long double tanl(long double x) { return __builtin_tanl(x); }

inline double tanh(double x) { return __builtin_tanh(x); }
inline float tanhf(float x) { return __builtin_tanhf(x); }
inline long double tanhl(long double x) { return __builtin_tanhl(x); }
...
inline double nan(const char *str) { return __builtin_nan(str); }

inline float nanf(const char *str) { return __builtin_nanf(str); }

inline long double nanl(const char *str) { return __builtin_nanl(str); }

inline double hugeVal() { return __builtin_huge_val(); }
inline float hugeValf() { return __builtin_huge_valf(); }
inline long double hugeVall() { return __builtin_huge_vall(); }
inline double infinity() { return __builtin_huge_val(); }
inline float infinityf() { return __builtin_huge_valf(); }
inline long double infinityl() { return __builtin_huge_vall(); }

inline int fpclassify(double x) {
  return __builtin_fpclassify(x, __builtin_huge_val(), __builtin_nan(""), 0.0,
                              0.0, 1.0);
}
...
inline bool isless(double x, double y) { return __builtin_isless(x, y) != 0; }
...
inline long double nearbyintl(long double x) { return __builtin_nearbyintl(x); }

inline double nextafter(double x, double y);
inline float nextafterf(float x, float y) { return __builtin_nextafterf(x, y); }
...
inline long double rintl(long double x) { return __builtin_rintl(x); }

inline double round(double x) { return __builtin_round(x); }
inline float roundf(float x) { return __builtin_roundf(x); }
inline long double roundl(long double x) { return __builtin_roundl(x); }
inline double scalbln(double x, int ex) { return __builtin_scalbln(x, ex); }
inline float scalblnf(float x, int ex) { return __builtin_scalblnf(x, ex); }
inline long double scalblnl(long double x, int ex) {
  return __builtin_scalblnl(x, ex);
}
inline double scalbn(double x, int ex) { return __builtin_scalbn(x, ex); }
inline float scalbnf(long double x, int ex) { return __builtin_scalbnf(x, ex); }
inline double scalbln(double x, long ex) { return __builtin_scalbln(x, ex); }
inline float scalblnf(float x, long ex) { return __builtin_scalblnf(x, ex); }
inline long double scalblnl(long double x, long ex) {
  return __builtin_scalblnl(x, ex);
}

inline float scalbnf(float x, int ex) { return __builtin_scalbnf(x, ex); }
...
inline long double tgammal(long double x) { return __builtin_tgammal(x); }

inline double trunc(double x) { return __builtin_trunc(x); }
inline float truncf(float x) { return __builtin_truncf(x); };
inline long double truncl(long double x) { return __builtin_truncl(x); }
...
inline constexpr long double lerp(long double a, long double b,
...
inline bool isfinite(long double x) { return __builtin_isfinite(x) != 0; }

inline double nextafter(double x, double y) {
  return __builtin_nextafter(x, y);
}
inline int signbitf(float x) { return __builtin_signbitf(x); }
inline int signbitl(long double x) { return __builtin_signbitl(x); }
//===================STRING======================//

inline unsigned long strlen(const char *str) { return __builtin_strlen(str); }
...
template <typename... Args>
inline int snprintf(char *restrict s, unsigned long n,
                    const char *restrict format, Args... args) {
...
inline int vsprintf(char *restrict s, const char *restrict format,
                    va_list ap...) {
  return __builtin_vsprintf(s, format, ap);
}
inline int vsscanf(const char *restrict s, const char *restrict format,
                   va_list ap...) {
  return __builtin_vsscanf(s, format, ap);
}

inline int vsnprintf(char *restrict s, unsigned long n,
                     const char *restrict format, va_list ap...) {
  return __builtin_vsnprintf(s, n, format, ap);
}
inline int wmemcmp(const wchar_t *lhs, const wchar_t *rhs,
                   unsigned long count) {
  return __builtin_wmemcmp(lhs, rhs, count);
}
inline wchar_t *wmemcpy(wchar_t *dest, const wchar_t *src,
                        unsigned long count) {
  return __builtin_wmemcpy(dest, src, count);
}
inline wchar_t *wmemmove(wchar_t *dest, const wchar_t *src,
                         unsigned long count) {
